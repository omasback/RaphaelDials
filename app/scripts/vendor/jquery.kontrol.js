    ...
    k.Dial = function () {
        ...
        this.xy2val = function (x, y, m) {
            ...
            // } else {
                ...
                //w2 is half the width of the canvas
                a = Math.atan2(
                    x - (this.x + this.w2)
                    , - (y - this.y - this.w2)
                ) - this.angleOffset;
        ...
        this.init = function () {
            ...
            this.lineWidth = this.o.thickness;
        ...
        this.draw = function () {
            ...
            if (this.o.cursor) {
                c.beginPath();
                    ...
                    c.arc(this.xy+Math.cos(eat)*this.radius, this.xy+Math.sin(eat)*this.radius, this.o.cursor, 0, 360, false);
                c.stroke();
            }
